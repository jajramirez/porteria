        ...
        <nav class="navbar navbar-default ">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><img src="{{asset('template/assets/img/logo.png')}}" alt=""></a>
                </div>

                <div class="collapse navbar-collapse yamm" id="navigation">
                    <div class="button navbar-right">
                        <a class="navbar-btn nav-button wow bounceInRight login" href="{{ route('login') }}" data-wow-delay="0.45s">Login</a>
        ...
        <div class="footer-area">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                            <div class="single-footer">
                                ...
                                <img src="{{asset('template/assets/img/footer-logo.png')}}" alt="" class="wow pulse" data-wow-delay="1s">
                                <p>Lorem ipsum dolor cum necessitatibus su quisquam molestias. Vel unde, blanditiis.</p>
                                <ul class="footer-adress">
                                    <li><i class="pe-7s-map-marker strong"> </i> Direccion</li>
                                    <li><i class="pe-7s-mail strong"> </i> correo</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3 col-sm-6 wow fadeInRight animated">
                                ...
                                <ul class="footer-blog">
                                    <li>
                                        <div class="col-md-3 col-sm-4 col-xs-4 blg-thumb p0">
                                            <a href="single.html">
                                                <img src="{{asset('template/assets/img/demo/small-proerty-2.jpg')}}">
                                            </a>
                                            <span class="blg-date">12-10-2017</span>

                                        </div>
                                        <div class="col-md-8  col-sm-8 col-xs-8  blg-entry">
                                            <h6> <a href="single.html">Titulo noticias </a></h6> 
                            ...
                            <div class="single-footer news-letter">
                                ...
                                <form>
                                    <div class="input-group">
                                        <input class="form-control" type="text" placeholder="Correo Registro">
            ...
            <div class="footer-copy text-center">
                <div class="container">
                    <div class="row">
                        <div class="pull-left">
                            <span> (C) <a href="#"></a>Todos los derechos reservados. 2017. </span> 
                        </div> 
                        <div class="bottom-menu pull-right"> 
                            <ul> 
                                <li><a class="wow fadeInUp animated" href="#" data-wow-delay="0.2s">Mi comunidad</a></li>
                                <li><a class="wow fadeInUp animated" href="#" data-wow-delay="0.3s">Mensajes</a></li>
                                <li><a class="wow fadeInUp animated" href="#" data-wow-delay="0.4s">Reservas</a></li>
